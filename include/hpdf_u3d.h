...
HPDF_EXPORT(HPDF_JavaScript)  HPDF_CreateJavaScript(                 HpdfDoc const * const doc, char const *code);
HPDF_EXPORT(HPDF_JavaScript)  HPDF_LoadJSFromFile(                   HpdfDoc       * const doc, char const *filename);
HPDF_EXPORT(HPDF_U3D)         HPDF_LoadU3DFromFile(                  HpdfDoc       * const doc, char const *filename);
HPDF_EXPORT(HPDF_Image)       HPDF_LoadU3DFromMem(                   HpdfDoc       * const doc, HpdfByte const * const buffer, HpdfUInt size);
HPDF_EXPORT(HPDF_Dict)        HPDF_Create3DView(                     HpdfMemMgr * const mmgr, char const *name);
HPDF_EXPORT(HpdfStatus)       HPDF_U3D_Add3DView(                    HPDF_U3D u3d, HPDF_Dict view);
HPDF_EXPORT(HpdfStatus)       HPDF_U3D_SetDefault3DView(             HPDF_U3D u3d, char const *name);
HPDF_EXPORT(HpdfStatus)       HPDF_U3D_AddOnInstanciate(             HPDF_U3D u3d, HPDF_JavaScript javaScript);
HPDF_EXPORT(HPDF_Dict)        HPDF_3DView_CreateNode(                HPDF_Dict view, char const *name);
...
HPDF_EXPORT(HpdfStatus)       HPDF_3DView_SetLighting(               HPDF_Dict view, char const *scheme);
...
HPDF_EXPORT(HpdfStatus)       HPDF_3DView_SetCrossSectionOff(        HPDF_Dict view);
            HPDF_Dict         HPDF_3DView_New(                       HpdfMemMgr * const mmgr, HPDF_Xref  xref, HPDF_U3D	u3d, char const *name);

#if defined(WIN32)
HPDF_EXPORT(HPDF_JavaScript)  HPDF_LoadJSFromFileW(                  HpdfDoc       * const doc, wchar_t const *filename);
HPDF_EXPORT(HPDF_U3D)	      HPDF_LoadU3DFromFileW(                 HpdfDoc       * const doc, wchar_t const *filename);
#endif
