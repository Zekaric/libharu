      ...
      HpdfEncoder * const encoder)
{
   ...
   if ((ret = HPDF_CMapEncoder_AddCMap(encoder, CMAP_ARRAY_GBK_EUC_H)) != HPDF_OK)
   {
      return ret;
   }

   if ((ret = HPDF_CMapEncoder_AddCMap(encoder, CMAP_ARRAY_GBK_EUC_V)) != HPDF_OK)
   {
      return ret;
   }
      ...
      HpdfDoc * const doc)
{
   ...
   encoder = HPDF_CMapEncoder_New(doc->mmgr, "GBK-EUC-H", GBK_EUC_H_Init);
   ...
   /* Microsoft Code Page 936(lfCharSet 0x86) GBK encoding
    *(vertical writing) */
   encoder = HPDF_CMapEncoder_New(doc->mmgr, "GBK-EUC-V", GBK_EUC_V_Init);
   ...
   /* EUC-CN encoding */
   encoder = HPDF_CMapEncoder_New(doc->mmgr, "GB-EUC-H", GB_EUC_H_Init);
   ...
   encoder = HPDF_CMapEncoder_New(doc->mmgr, "GB-EUC-V", GB_EUC_V_Init);
